...
// ==========================
// ChirpBrand (Noir) - Couleur primaire
// ==========================
// ==========================
// ChirpBrand (Noir) - Couleur primaire
// ==========================
val ChirpBrand1000 = Color(0xFFF5F5F5)       // Noir pur
val ChirpBrand900  = Color(0xFF1A1A1A)       // Très foncé
val ChirpBrand600  = Color(0xFF333333)       // Foncé intermédiaire
val ChirpBrand500  = Color(0xFF4D4D4D)       // Gris moyen
val ChirpBrand500Alpha40 = Color(0x664D4D4D) // Gris moyen avec alpha 40%
val ChirpBrand100  = Color(0xFFF5F5F5)       // Très clair / presque blanc

// ==========================
// ChirpBase (Orange) - Couleur secondaire
// ==========================
val ChirpBase1000 = Color(0xFF101C28)        // Orange intense
val ChirpBase1000Alpha8 = Color(0x14FF5500)  // Alpha 8% pour overlay léger
val ChirpBase1000Alpha80 = Color(0xCCFF5500) // Alpha 80% pour overlay plus foncé
val ChirpBase950  = Color(0xFFFF7733)        // Orange foncé
val ChirpBase900  = Color(0xFFFF7733)        // Orange foncé (variant)
val ChirpBase800  = Color(0xFFFF9933)        // Orange moyen foncé
val ChirpBase700  = Color(0xFFFFB266)        // Orange moyen
val ChirpBase500  = Color(0xFFFFB266)        // Orange moyen (variant)
...
// ==========================
val ChirpBase100Alpha10     = Color(0x1AFF5500) // Orange 10% alpha pour light mode surface
val ChirpBase1000Alpha14    = Color(0x24FF5500) // Orange 14% alpha pour outline sombre
val ChirpBase100Alpha10Alt  = Color(0x1AFF5500) // Orange 10% alpha pour dark mode surface
val ChirpBase0              = Color(0xFF101C28) // Orange pur pour éléments accentués/*
